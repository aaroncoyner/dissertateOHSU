...
#' \dontrun{
#' library(rmarkdown)
#' draft("MyArticle.Rmd", template = "dissertateOHSU", package = "dissertateOHSU")
#' }
#'
#' @import rticles
#' @import yaml
#'
#' @export
dissertateOHSU <- function(..., highlight = NULL, citation_package = "none") {
  inherit_pdf_document(...,
                       template = find_resource("dissertateOHSU", "template.tex"),
                       highlight = highlight,
